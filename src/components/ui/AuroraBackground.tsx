...
export const AuroraBackground = ({
  ...
  return (
    <main  className="w-screen h-screen">
      <div
        className={cn(
          "relative flex flex-col items-center justify-center bg-slate-400/50 text-slate-950 dark:bg-zinc-900 transition-bg",
          className
        )}
        {...props}
      >
        ...
        <div
          ...
          style={
            {
              "--aurora":
                "repeating-linear-gradient(100deg,#3b82f6_10%,#a5b4fc_15%,#93c5fd_20%,#ddd6fe_25%,#60a5fa_40%)",
              "--dark-gradient":
                "repeating-linear-gradient(100deg,#000_0%,#000_7%,transparent_10%,transparent_15%,#000_20%)",
              "--white-gradient":
                "repeating-linear-gradient(100deg,#fff_0%,#fff_10%,transparent_20%,transparent_32%,#fff_46%)",
