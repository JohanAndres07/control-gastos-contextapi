...
export default function ExpenseModal() {
  ...
  return (
    <>
      <div className=" modal fixed right-5 bottom-5 flex items-center justify-center">
        <button type="button" 
      ...
      <Transition appear show={state.modal} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={() => dispatch({ type: 'close-modal' })}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full bg-black/30 backdrop-blur-sm  items-center justify-center p-4 text-center">
              <TransitionChild
                as={Fragment}
                enter="ease-out duration-300"
